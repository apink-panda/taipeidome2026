...
const fishI18n = {
  zh: {
    ...
    startRule2: "五隻 Ping Doongs 輪流當釣手；釣到<strong>同色</strong>明太魚加 <strong>10 分</strong>，同色雙魚加 <strong>30 分</strong>。限時 60 秒！",
  ...
  en: {
    ...
    startRule2: "Five Ping Doongs take turns fishing. A <strong>same-color</strong> fish scores <strong>+10</strong>, and a same-color double catch scores <strong>+30</strong>. You have 60 seconds!",
  ...
  ja: {
    ...
    startRule2: "5匹の Ping Doongs が交代で釣り手に。<strong>同じ色</strong>は<strong>+10点</strong>、同色2匹なら<strong>+30点</strong>。制限時間は60秒！",
  ...
  ko: {
    ...
    startRule2: "다섯 Ping Doongs가 번갈아 낚시해요. <strong>같은 색</strong> 명태는 <strong>+10점</strong>, 같은 색 두 마리는 <strong>+30점</strong>. 제한 시간은 60초!",
