...
const performanceI18n = {
  zh: {
    ...
    heading: "開球及<br />賽後表演",
    intro: "7/31 台北大巨蛋新光音樂季表演：從開球瞬間到賽後舞台，收藏五位成員與 Apink 團體的每一個粉色時刻。",
  ...
  en: {
    ...
    intro: "July 31 Shin Kong Music Festival at Taipei Dome: Relive every pink moment—from the ceremonial first pitch to Apink's postgame stage.",
    kicker: "PANDA VIDEO ARCHIVE",
    libraryTitle: "Members & Group Videos",
    tabsAria: "Video categories",
    loading: "Syncing posts and videos…",
    total: "{count} videos",
  ...
  ja: {
    ...
    intro: "7月31日 台北ドーム新光音楽祭公演：始球式の瞬間から試合後のステージまで、5人とApinkのピンク色の思い出を集めました。",
    kicker: "PANDA VIDEO ARCHIVE",
  ...
  ko: {
    ...
    intro: "7월 31일 타이베이 돔 신광 음악제 공연: 시구의 순간부터 경기 후 무대까지, 다섯 멤버와 Apink의 모든 분홍빛 순간을 모았습니다.",
    kicker: "PANDA VIDEO ARCHIVE",
    libraryTitle: "멤버 및 단체 영상",
    tabsAria: "영상 분류",
    loading: "게시물과 영상을 동기화하고 있어요…",
    total: "영상 {count}개",
